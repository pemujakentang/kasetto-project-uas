...
import bonbon from "../assets/ppics/bonbon.jpg";
import samuel from "../assets/ppics/samuel.jpg";
import friedrich from "../assets/ppics/friedrich.jpg";
import stefan from "../assets/ppics/stefan.jpg";
      ...
      <div className="abt_container">
        <div className="app_info">
          ...
          <div className="app_info_body">
            <h4>
              Kasetto adalah music player bertemakan retro cassette player.
              Kasetto dibuat menggunakan React JS dan Spotify API.
            </h4>
            <h4>
              Di tengah era digital yang serba canggih, terkadang kita
              menginginkan nostalgia dari masa lalu. Salah satu cara orang
              bernostalgia adalah melalui musik. Music player ini bertemakan
              retro cassette player, melalui music player ini pengguna dapat
              bernostalgia sensasi mendengarkan musik ala tempo doeloe.
            </h4>
            <div className="toGithub">
              <a
                target="_blank"
                href="https://github.com/pemujakentang/kasetto-project-uas"
              >
                <button className="navButton btnGithub">
                  Github Repository
                </button>
              </a>
            </div>
        ...
        <div className="grid_container">
          <div className="card c1">
            ...
            <div className="cardinfo">
              ...
              <div className="socialIcons">
                <a
                  target="_blank"
                  href="https://www.instagram.com/martin_bonifasius/"
                >
                  <svg
                ...
                <a
                  target="_blank"
                  href="https://www.facebook.com/martin.wibawa.3/"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a target="_blank" href="https://github.com/pemujakentang">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a
                  target="_blank"
                  href="mailto:bonifasius.martin@student.umn.ac.id"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
          ...
          <div className="card c2">
            ...
            <div className="cardinfo">
              ...
              <div className="socialIcons">
                <a
                  target="_blank"
                  href="https://www.instagram.com/samuel._.mxms/"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a
                  target="_blank"
                  href="https://www.facebook.com/samuellamere12"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a target="_blank" href="https://github.com/SamuelMaxs">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a
                  target="_blank"
                  href="mailto:samuel.maximus@student.umn.ac.id"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
          ...
          <div className="card c2">
            ...
            <div className="cardinfo">
              ...
              <div className="socialIcons">
                ...
                <a
                  target="_blank"
                  href="https://www.facebook.com/gerard.stefan.39"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a target="_blank" href="https://github.com/thestrixy">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a
                  target="_blank"
                  href="mailto:gerard.stefan@student.umn.ac.id"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
          ...
          <div className="card c1">
            <img src={friedrich} alt="" />
            <div className="cardinfo">
              <h2>Friedrich Litani</h2>
              <h4>00000068855</h4>
              ...
              <div className="socialIcons">
                <a
                  target="_blank"
                  href="https://www.instagram.com/friedrich19_litani/"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a
                  target="_blank"
                  href="https://www.facebook.com/profile.php?id=100010685118050"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a target="_blank" href="https://github.com/Friedrich19">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <a
                  target="_blank"
                  href="mailto:friedrich.litani@student.umn.ac.id"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
